...
#Полиморфизм подход предусматривающий возможность взаимодействия с различными типами данных единым образом в отсутствие информации о конкретном типе данных объекта. 
Отношения между Student/Person демонстрируют концепцию computer science concept known as #polymorphism. Полиморфизм – это способность языка программирования по-разному относиться к объекту в зависимости от контекста.
...
Переопределенный метод с именем someMethod() может вызвать одноименный метод суперкласса, используя конструкцию super.someMethod() внутри своей реализации (в коде переопредел метода) 
