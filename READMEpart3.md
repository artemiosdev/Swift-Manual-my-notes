...
- [Глава №37. Protocols ](#chapter37)
- [Глава №38. Расширения ](#chapter38)
- [Глава №39. Протокол-ориентированное программирование ](#chapter39)
- [Глава №40. Знакомство с SwiftUI, сравнение с UIKit ](#chapter40)
- [Глава №41. Универсальные шаблоны (Generic) ](#chapter41)
- [Глава №42. Обработка ошибок ](#chapter42)
- [Глава №43. Нетривиальное использование операторов ](#chapter43)
...
<img alt="image" src="images/множественное наследование с протоколами.jpg"  width = 45%/>
...
###  <a id="chapter40" /> Глава 40. Знакомство с SwiftUI, сравнение с UIKit
...
[Пояснение](https://tproger.ru/translations/imperative-declarative-programming-concepts/)
...
Аргумент preferedStyle инициализатора класса, имеющий тип UIAlertController.Style, определяет стиль всплывающего окна: Alert или Action Sheet. 
...
- Дополните showAlert() выводом всплывающего окна с помощью метода  present(_:ani-mated:completion) 
...
Пример `UIAlertAction.Style.cancel`
...
**@IBAction** доступ элементов сцены к методам класса. Для создания обратной связи (организовать доступ к графическому элементу из кода) служит ключевое слово **#@IBOutlet** под названием аутлет. 
...
[Пояснение по императивному и декларативному подходу](https://tproger.ru/translations/imperative-declarative-programming-concepts/)
...
3. Подписать ViewController под протокол UITableViewDataSource. 
...
Нет ViewController.swift и Main.storyboard. При использовании SwiftUI необходимости в них нет. Также отсутствует и файл AppDelegate.swift, который позволял управлять жизненным циклом приложения. 
...
#Canvas – это спец панель предварительного просмотра, появившаяся в Xcode вместе со SwiftUI. Она в некотором роде заменяет уже знакомый вам storyboard, позволяя, без необходимости запускать приложение на симуляторе, видеть созданный с помощью программного кода графический интерфейс. 

Для быстрого обновления Canvas используйте сочетание клавиш `Command + Option + P`. 
...
Так, в данном случае ContentView – это базовое родительское представление, в состав которого входит другое представление (Text также соответствует протоколу View). 
...
При необходимости вы можете создать дополнительный Preview на Canvas. 
...
###  <a id="chapter41" /> Глава №41. Универсальные шаблоны (Generic) 
...
// ОШИБКА! Код недопустим, тк функция должна возвращать значение конкретного типа данных, а не одного из ..
```
...
###  <a id="chapter42" /> Глава №42. Обработка ошибок 
...
###  <a id="chapter43" /> Глава №43. Нетривиальное использование операторов 
