...
###  <a id="chapter37" /> Глава №37. Протоколы. Понятие протокола Protocols
...
Приведенный код, называется универсальным шаблоном (generic) и будет подробно рассмотрен в следующих главах. 
...
Как вы знаете, расширения могут применяться к любым объектным типам. В этом разделе отдельно рассмотреть возможности совместного использования расширений и протоколов. 
...
Правило No 2 
Используйте классы только тогда, когда вам действительно нужны их особенности (наследование и ссылочный тип). 
