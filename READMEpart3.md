...
### ЧАСТЬ VII Архитектура и паттерны
...
<img alt="image" src="images/mvc3.jpeg"  width = 80%/>
...
View – отвечает за взаимодействие с пользователем. Код View определяет внешний вид приложения и способы его использования.
...
Controller – отвечает за связь между Model и View. Код Controller определяет, как приложение реагирует на действия пользователя. По сути, это нервный импульс, который обращается к мозгу (Model). Знает и обрабатывает запросы/входящую информацию от пользователя.
...
<img alt="image" src="images/mvc2.jpeg"  width = 70%/>

<img alt="image" src="images/mvc.jpeg"  width = 70%/>
<img alt="image" src="images/mvc.jpeg"/>
<img alt="image" src="images/mvc.jpeg"/>
